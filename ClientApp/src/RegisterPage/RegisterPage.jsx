            ...
            <div>
                ...
                <Formik
                    ...
                    onSubmit={({ username, password, firstName, lastName, phoneNumber, personalNumber }, { setStatus, setSubmitting }) => {
                        setStatus();
                        authenticationService.registration(username, password, firstName, lastName, phoneNumber, personalNumber)
                            .then(
                                user => {
                    ...
                    render={({ errors, status, touched, isSubmitting }) => (
                        <Form>
                            ...
                            <div className="form-group">
                                <button type="submit" className="btn btn-primary" disabled={isSubmitting}>Registration</button>
                                {isSubmitting &&
